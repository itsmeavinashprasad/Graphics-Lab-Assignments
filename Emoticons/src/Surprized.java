...
public class Surprized 
{
    ...
    public void draw()
    {
        ...
        //eyebrow
        obj3.draw(xc+10, yc-32, xc+32, yc-27, origin_x, origin_y, bd, bd, g);
        obj3.draw(xc-10, yc-32, xc-32, yc-27, origin_x, origin_y, bd, bd, g);
        
        //smile
        obj2.draw(xc, yc+13, 12, 15, origin_x, origin_y, bd, new int [] {1,2,3,4,5,6,7,8}, g);
